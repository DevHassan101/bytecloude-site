...
export default function HeroBanner() {
    ...
    const sliderSettings = {
        ...
        fade: true,
        arrows: false,
        beforeChange: (_current: number, next: number) => setCurrentSlide(next), // underscore se unused warning nahi aayegi
        lazyLoad: 'ondemand' as const, // ✅ Lazy loading enable
    };

    // ✅ Variants ko component ke bahar define karo (re-render pe dobara nahi banenge)
    const containerVariants: Variants = {
        hidden: { opacity: 0, y: 30 },
        visible: {
            opacity: 1,
    ...
    return (
        <section className="hero-banner">
            ...
            {/* ✅ Floating Icons - Images ko lazy load karo */}
            <div className="content-overlay" aria-hidden="true">
                <div className="content-icons">
                    <div className="content-left">
                        <span className="span1 -translate-y-8 translate-x-12">
                            <Image 
                                ...
                                quality={75} // ✅ Quality kam rakho
                            />
                        </span>
                        <span className="span2 -translate-y-6 -translate-x-6">
                            <Image src="/images/4.png" alt="" width={35} height={35} loading="lazy" quality={75} />
                        </span>
                        <span className="span3 translate-y-5 translate-x-12">
                            <Image src="/images/3.png" alt="" width={35} height={35} loading="lazy" quality={75} />
                        </span>
                    </div>
                    <div className="content-right">
                        <span className="span4 -translate-y-8 -translate-x-12">
                            <Image src="/images/1.png" alt="" width={35} height={35} loading="lazy" quality={75} />
                        </span>
                        <span className="span5 -translate-y-6 translate-x-6">
                            <Image src="/images/5.png" alt="" width={35} height={35} loading="lazy" quality={75} />
                        </span>
                        <span className="span6 translate-y-5 -translate-x-10">
                            <Image src="/images/2.png" alt="" width={35} height={35} loading="lazy" quality={75} />
                        </span>
                    </div>
                </div>
            </div>
